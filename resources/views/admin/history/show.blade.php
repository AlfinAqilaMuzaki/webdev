    ...
    <div class="card bg-base-100 shadow-md">
      <div class="lg:flex ">
        ...
        <div class="card-body lg:w-2/3">
          ...
          @if($order->tipePembayaran)
          <div class="divider"></div>
          <div class="space-y-2">
            <div class="flex justify-between items-center">
              <span class="font-bold">Metode Pembayaran</span>
              <span>{{ $order->tipePembayaran->nama }}</span>
            </div>
            @if($order->tipePembayaran->deskripsi)
            <div class="bg-base-200 p-3 rounded-lg">
              <p class="text-sm text-gray-600">{{ $order->tipePembayaran->deskripsi }}</p>
            </div>
            @endif
          </div>
          @endif
